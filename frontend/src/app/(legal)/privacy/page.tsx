/**
 * Privacy Policy Page - Matching Landing Page Design
 */
...
import { ArrowLeft24Regular, Translate24Regular } from '@fluentui/react-icons';
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="flex items-center justify-between h-20">
            ...
            <div className="hidden md:block text-center">
              <h1 className="text-xl font-semibold text-th-text">{legal.privacy.title}</h1>
              <p className="text-sm text-th-text-t">{legal.privacy.subtitle}</p>
            </div>
      ...
      <main className="relative pt-32 pb-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          ...
          <div className="md:hidden text-center mb-8">
            <h1 className="text-2xl font-bold text-th-text">{legal.privacy.title}</h1>
            <p className="text-sm text-th-text-t mt-1">{legal.privacy.subtitle}</p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <div className="flex items-center gap-8 text-th-text-t">
              <Link href="/privacy" className="text-th-text">{t.footer.privacy}</Link>
