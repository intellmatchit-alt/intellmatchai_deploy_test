      ...
      <div className="relative">
        ...
        <div className="relative bg-[#131b2e]/85 backdrop-blur-xl border border-white/[0.10] rounded-2xl p-8 shadow-2xl ring-1 ring-[#00d084]/[0.06] text-center">
          ...
          <div className="space-y-4">
            <button onClick={() => setIsSubmitted(false)} className="w-full py-3 bg-white/[0.05] border border-white/[0.08] rounded-xl text-white hover:bg-white/[0.08] hover:border-white/[0.12] transition-all duration-200">{t.auth.forgotPassword.tryAnother}</button>
            <Link href="/login" className="flex items-center justify-center gap-2 text-[#00d084] hover:text-[#00e896] hover:underline underline-offset-4 transition-all duration-200">
    ...
    <div className="relative">
      ...
      <div className="relative bg-[#131b2e]/85 backdrop-blur-xl border border-white/[0.10] rounded-2xl p-8 shadow-2xl ring-1 ring-[#00d084]/[0.06]">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            ...
            <div className="relative">
              ...
              <input type="email" value={email} onChange={(e) => setEmail(e.target.value)} placeholder={t.auth.forgotPassword.emailPlaceholder} disabled={isLoading} autoFocus
                className={`w-full ps-12 pe-4 py-3 bg-white/[0.05] border ${error ? 'border-red-500' : 'border-white/[0.08]'} rounded-xl text-white placeholder-[#56657a] focus:outline-none focus:bg-white/[0.07] focus:ring-2 focus:ring-[#00d084]/30 focus:border-[#00d084]/60 transition-all duration-200`} />
            </div>
          ...
          <Link href="/login" className="flex items-center justify-center gap-2 text-[#00d084] hover:text-[#00e896] hover:underline underline-offset-4 transition-all duration-200 mt-6">
            <ArrowLeft24Regular className="w-5 h-5 rtl:rotate-180" />
            {t.auth.forgotPassword.backToSignIn}
          </Link>
        </form>
