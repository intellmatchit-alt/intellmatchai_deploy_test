    ...
    return (
      <div className="space-y-6 animate-fade-in pb-20">
        ...
        <div className="bg-th-surface border border-th-border rounded-xl p-8 text-center">
          ...
          <Link href="/checkout?plan=TEAM" className="mt-4 inline-block px-6 py-2.5 bg-[#3b82f633] text-white rounded-xl font-thin hover:shadow-lg hover:shadow-[#3b82f6]/25 transition-all">
        ...
        <div className="relative p-6">
          <div className="flex items-start justify-between">
            <div className="flex items-center gap-4">
              ...
              <div className="relative">
                <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-emerald-500 to-emerald-600 flex items-center justify-center text-white text-2xl font-bold shadow-lg shadow-[#3b82f6]/20">
              ...
              <div className="flex-1">
                ...
                <div className="flex items-center gap-3 mt-1.5">
                  <span className="inline-flex items-center gap-1 px-2.5 py-0.5 bg-emerald-500/20 text-[#93c5fd] text-xs rounded-full font-semibold border border-emerald-500/20">
                ...
                {editing ? (
                  <>
                    <button onClick={handleSave} disabled={saving} className="p-2 bg-emerald-500/20 hover:bg-emerald-500/30 rounded-xl transition-colors border border-emerald-500/20">
                      <Checkmark24Regular className="w-5 h-5 text-[#93c5fd]" />
                    </button>
          ...
          <div className="mt-4">
            ...
            <div className="h-1.5 bg-th-surface-h rounded-full overflow-hidden">
              <div
                className="h-full bg-[#3b82f633] rounded-full transition-all duration-700 ease-out"
          ...
          return (
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="font-medium text-th-text group-hover:text-[#93c5fd] transition-colors">{link.label}</p>
